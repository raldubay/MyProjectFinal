...
# --------------------------------------------------------------------------- #
	...
	if(isset($_POST['loginSubmit'])) // If the user pressed the Submit button
	{
		...
		if ($uname == "username" && $pass == "password")
		{
			...
			if ($_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~raldubay/IndividualProject/outdex.php" 
			    || $_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~raldubay/IndividualProject/login.php" )
			{
